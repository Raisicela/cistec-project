...
const items: ItemProps[] = [
    ...
    {
        title: '03',
        subtitle: 'Ingenierías y arquitecturasMantenimiento y reparación de espacios',
  ...
  return (
    ...
    >
        <div className='flex flex-col justify-center items-center w-screen mt-20 mb-10'>
            <p className='text-[12px] text-[#00000080] text-center'>TRANSFORMAMOS ESPACIOS EN LUGARES EXTRAORDINARIOS</p>
            <p className=' font-bold text-2xl text-[#000000] text-center mx-5'>¡Descubre el poder de construir <br/> tus sueños con CISTEC!</p>
...
const _Item = (props: ItemProps) => {
  return (
    <div className='flex flex-col rounded-xl bg-[#E0E0E0C8] mx-5 p-5 md:w-1/3 lg:w-1/4'>
        <p className='text-5xl font-bold text-center text-[#444242]'>{props.title}</p>
        <p className='text-lg font-bold text-center'>{props.subtitle}</p>
        <p className='text-sm font-light text-justify mt-3'>{props.description}</p>
    </div>
  )
}
